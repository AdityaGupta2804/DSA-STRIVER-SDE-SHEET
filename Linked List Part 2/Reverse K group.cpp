...
class Solution{
public:
    static pair<ListNode*, ListNode*> reverse(ListNode* head, int k) {
        ListNode* prev = nullptr;
        ListNode* curr = head;
        ListNode* next = nullptr;
        int count = 0;
        ...
        return {prev, head};  // prev is new head, head becomes new tail
    }
    ListNode* reverseKGroup(ListNode* head, int k) {
        ...
        while (length >= k) {
            ...
            pair<ListNode*, ListNode*> reversedPair = reverse(grouphead, k);
            ListNode* newGroupHead = reversedPair.first;
            ListNode* newGroupTail = reversedPair.second;
            ...
            newGroupTail->next = nextgroup;
            prevtail = newGroupTail;
            curr = nextgroup;
            length -= k;
        }
