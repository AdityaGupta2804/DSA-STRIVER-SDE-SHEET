...
void solve() {
    ...
    cin >> removePos; // n-th node from end

    Solution sol;
    ListNode* updatedHead = sol.removeNthFromEnd(list.getHead(), removePos);
    list.setHead(updatedHead);

    cout << "After removing " << removePos << "-th node from end: ";
    list.display();
}
